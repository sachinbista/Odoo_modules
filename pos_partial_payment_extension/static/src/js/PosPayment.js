...
odoo.define('pos_partial_payment_extension.pos_payment', function(require) {
	"use strict";
	...
	const POSPayment = (PosGlobalState) => class POSPayment extends PosGlobalState {
		...
		async _processData(loadedData) {
			...
			this._loadPosPaymentMethod(loadedData['pos.payment.method']);
		...
		_loadPosPaymentMethod(journals){
			var self = this;
