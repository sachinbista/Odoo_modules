    ...
    def get_sale_details(self, date_start=False, date_stop=False, config_ids=False, session_ids=False):
        ...
        for order in orders:
            ...
            for line in order.lines:
                ...
                key = (line.product_id, line.price_unit, line.discount, customer_note, subtotal)
        ...
        return {
            ...
            'products': sorted([{
                ...
                'subtotal': subtotal,
            } for (product, price_unit, discount, customer_note, subtotal), qty, in products_sold.items()],
