...
class DrSearchReport(models.Model):
    ...
    clicked_type = fields.Selection([('product', 'Product'), ('category', 'Category'), ('autocomplete', 'Autocomplete'), ('suggestion', 'Suggestion'), ('brand', 'Brand'), ('brand_family', 'Brand Family')], readonly=True)
