...
class DrThemeConfig(models.Model):
    ...
    def _get_default_theme_config(self, website_id):
        ...
        return {
            ...
            'json_mobile': {},
            'json_product_search': {'advance_search': True, 'search_category': True, 'search_product_brand': True, 'search_attribute': True, 'search_suggestion': True, 'search_limit': 10, 'search_max_product': 3, 'search_fuzzy': True, 'search_fill_products': False, 'search_report': True, 'delete_search_report': 90},
