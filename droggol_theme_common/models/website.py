...
class Website(models.Model):
    ...
    def _search_get_details(self, search_type, order, options):
        ...
        if search_type in ['search_product_brand']:
            result.append(self.env['product.attribute.value']._search_get_detail(self, order, options))
        if search_type in ['search_brand_family']:
            result.append(self.env['product.brand.family']._search_get_detail(self, order, options))
        return result
