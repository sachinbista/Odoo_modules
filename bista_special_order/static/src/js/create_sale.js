odoo.define('bista_special_order.CreateSaleOrder', function(require) {
	'use strict';
	...
	const PosCreateSaleInherit = (CreateSale) => class PosCreateSaleInherit extends CreateSale{
		async onClick(){
			var self = this;
			...
			for (var i = 0; i < orderlines.length; i++) {
				var product_items = {
					...
					'is_special': orderlines[i].is_special,
				};
				console.log("orderlines[i].is_special",orderlines[i].is_special)
	...
	Registries.Component.extend(CreateSale,PosCreateSaleInherit);
});
