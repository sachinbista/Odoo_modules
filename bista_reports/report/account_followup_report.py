...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_followup_report_lines(self, options):
        """
        Method is override for customer po add
    ...
    def _get_followup_report_columns_name(self):
        """
        Method is override of add customer PO
        ...
        return [
            ...
            {'name': _('Customer PO'), 'style': 'text-align:right; white-space:nowrap;'},
