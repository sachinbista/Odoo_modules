...
class AgedPartnerBalanceCustomHandler(models.AbstractModel):
    ...
    def _aged_partner_report_custom_engine_common(self, options, internal_type, current_groupby, next_groupby, offset=0, limit=None):
        ...
        def build_result_dict(report, query_res_lines):
            ...
            if current_groupby == 'id':
                ...
                rslt.update({
                    ...
                    'po_reference': query_res['po_reference'] if 'po_reference' in query_res else '',
        ...
        always_present_groupby = "period_table.period_index, currency_table.rate, currency_table.precision,am.po_reference"
        if current_groupby:
        ...
        query = f"""
            ...
            SELECT
                ...
                am.po_reference as po_reference,
