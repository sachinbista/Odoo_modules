...
class CommissionMixin(models.AbstractModel):
    ...
    def _prepare_agents_vals_partner(self, record, settlement_type=None):
        ...
        agents = record.partner_id.agent_ids
        if settlement_type:
...
class CommissionLineMixin(models.AbstractModel):
    ...
    # Removed the required attrib as this is was giving issue while create invoice. - 02122023
    # It's related to invoice agent_ids in invoices.
    # required = True,
    ...
    def _get_commission_amount(self, commission, subtotal):
        ...
        if commission.amount_base_type == "net_amount":
            ...
            subtotal = subtotal * commission.percent/100
