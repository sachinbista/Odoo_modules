...
registry.category('theme_prime_mega_menu_cards')
    ...
    .add('s_tp_hierarchical_category_list_style', {supportedActions: ['limit', 'brand', 'label', 'count', 'style', 'background']})
    .add('s_tp_hierarchical_category_nav_style', {supportedActions: ['limit', 'brand', 'label', 'count', 'style', 'background']})
