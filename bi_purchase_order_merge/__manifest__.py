...
{
    'name': 'Merge Purchase Orders in Odoo',
    'version': '16.0.0.1',
    'category': 'Purchase',
...
Mesclar ordem do cliente, mesclar ordens de compra, ordem de mesclagem, mesclar dados,
     ...
     fusão de pedidos de compra
     aquisições de pedidos de compras
     pedido de compra de fusão
     pedido de mesclagem para cotação
     pedido de fusão de cotação
     pedido de mesclagem de pedidos de cotação
Fusionner une commande client, fusionner des commandes, fusionner une commande, fusionner des données,
     ...
     fusion d'ordre d'achat
     achat d'ordre de fusion
     ordre d'achat de fusion
     fusionner une demande de devis
     demande de devis fusion
     fusionner une requête d'ordres de cotation
دمج أمر المبيعات ، ودمج أوامر الشراء ، ودمج الطلب ، ودمج البيانات ، دمج طلب المبيعات ، دمج طلب الشراء ، طلب دمج مدمج ، دمج طلب الشراء أمر الشراء شراء أمر الاندماج أمر شراء الاندماج طلب دمج لعرض الأسعار طلب عرض الأسعار طلب دمج طلبات الاقتباس
...
Fusionar pedido de cliente, fusionar órdenes de compra, fusionar orden, fusionar datos,
     ...
     fusión de orden de compra
     orden de compra fusión
     orden de compra de fusión
     fusionar solicitud de cotización
     solicitud de fusión de cotizaciones
     solicitud de fusión de órdenes de cotización
...
""",
    ...
    'auto_install': False,
    'application': True,
    "live_test_url":'https://youtu.be/XyCKCavBPWU',
