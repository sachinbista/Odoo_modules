...
class ResPartner(models.Model):
    ...
    def _get_dropship_invoice_filter(self, args, context={}):
        ...
        partner_id = context.get('parent_id', False)
    ...
    def _name_search(self, name, args=None, operator='ilike', limit=100, name_get_uid=None):
        args = args or []
        context = dict(self._context) or {}
        args = self._get_dropship_delivery_filter(args, context=context)
        args = self._get_dropship_invoice_filter(args, context=context)
