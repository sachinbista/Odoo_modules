...
class ShipFromWarehouse(models.TransientModel):
    _name = 'ship.from.warehouse'
    ...
    def change_order_warehouse(self):
        ...
        order_ids = self.env['sale.order'].browse(active_ids or [])
        message = ""
