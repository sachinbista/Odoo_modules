//odoo.define('fds_payment_require.signature_form', function (require) {
//    'use strict';
//
...
//            var default_po = this.nameAndSignature.getPo();
...
//                defaultPo: this.$el.data('default-po'),
...
//
//            var name = this.nameAndSignature.getName();
//            var default_po = this.nameAndSignature.getName();
//            var signature = this.nameAndSignature.getSignatureImage()[1];
//
//            return this._rpc({
//                route: this.callUrl,
...
odoo.define('fds_payment_require.signature_form', function (require) {
    ...
    SignatureForm.include({
        ...
        _onClickSignSubmit: function (ev) {
            ...
            var name = this.nameAndSignature.getName();
            var default_po = this.nameAndSignature.getPo(); // Ensure getPo() method exists and works
            var signature = this.nameAndSignature.getSignatureImage()[1];
