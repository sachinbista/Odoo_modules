...
* Import of sales orders in Odoo and process invoices and delivery orders
    ...
    'data': [
        ...
        'data/min_orderdate_config_param.xml',
        ...
        'views/product_variant_concise_form_inherit.xml',
        'views/user_shopify_tag_mapping_views.xml',
        ...
        'wizard/cancel_shopify_order_views.xml',
    ],
